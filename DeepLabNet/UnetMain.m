...
imageDir = "ac3_EM_patch_256_overlap";%'kasturi_em'; %"ac3_EM_patch";
labelDir = "ac3_dbseg_images_bw_patch_new_256_overlap"%;'kasturi_labels'; %"ac3_dbseg_images_bw_patch_new";
...
for training_iter = 1:50
    ...
    save(strcat('unet_tv9901_epoch', int2str(training_iter*MaxEpoch),'.mat'), 'net', 'info');
end
